...
export function BottomBar() {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 z-50 h-16 bg-zinc-900/80 backdrop-blur-xl border border-white/5 rounded-3xl shadow-2xl overflow-hidden">
      <div className="grid h-full max-w-lg grid-cols-4 mx-auto font-medium">
        {tabs.map((tab) => {
          ...
          return (
            ...
            >
              <div className={`p-1.5 rounded-xl transition-all duration-300 ${isActive ? "bg-indigo-400/10 mb-0.5" : "mb-1"}`}>
